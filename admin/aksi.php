...
if ($_GET['act'] == 'insert_kontrak_tender') {
    mysqli_query($koneksi, "insert into kontrak_tender(no_tender,nama_tender,lingkup_kerjaan,no_surat,tgl_surat,kota_surat,tipe_penyedia_ph1,nama_penyedia_ph1,alamat_penyedia_ph1,no_akte_pendirian,tgl_akte_pendirian,wakil_sah_pendirian,tipe_penyedia_ph2,nama_penyedia_ph2,alamat_penyedia_ph2,nama_bank,no_rekening,nama_pemilik_rekening,nilai_kontrak,alasan_perubahan_nilai_kontrak,nama_pemilik_rekening_info,nama_produk,nama_usaha_mikro,jenis_kontrak,info_lainnya)values('" . $_POST['kode_tender'] . "','" . $_POST['nama_tender'] . "','" . $_POST['lingkup_pekerjaan'] . "','" . $_POST['no_surat'] . "','" . $_POST['tanggal_surat_perjanjian'] . "','" . $_POST['kota_surat_perjanjian'] . "','" . $_POST['tipe_penyedia_ph1'] . "','" . $_POST['nama_penyedia_ph1'] . "','" . $_POST['alamat_penyedia_ph1'] . "','" . $_POST['no_akte_pendirian'] . "','" . $_POST['tanggal_akte_pendirian'] . "','" . $_POST['wakil_sah_penyedia'] . "','" . $_POST['tipe_penyedia_ph2'] . "','" . $_POST['nama_penyedia_ph2'] . "','" . $_POST['alamat_penyedia_ph2'] . "','" . $_POST['nama_bank'] . "','" . $_POST['no_pemilik_rekening'] . "','" . $_POST['nama_pemilik_rekening'] . "','" . $_POST['nilai_kontrak'] . "','" . $_POST['alasan_perubahan_nilai_kontrak'] . "','" . $_POST['nama_pemilik_rekening_info'] . "','" . $_POST['nama_produk_dalam_negri'] . "','" . $_POST['nama_usaha_mikro'] . "','" . $_POST['jenis_kontrak'] . "','" . $_POST['informasi_lainnya'] . "')");
    header('location:add-sppbj-'.$_POST['id_tender']);
}

if ($_GET['act'] == 'insert_kontrak_non_tender') {
    mysqli_query($koneksi, "insert into kontrak_non_tender(no_tender,nama_tender,lingkup_kerjaan,no_surat,tgl_surat,kota_surat,tipe_penyedia_ph1,nama_penyedia_ph1,alamat_penyedia_ph1,no_akte_pendirian,tgl_akte_pendirian,wakil_sah_pendirian,tipe_penyedia_ph2,nama_penyedia_ph2,alamat_penyedia_ph2,nama_bank,no_rekening,nama_pemilik_rekening,nilai_kontrak,alasan_perubahan_nilai_kontrak,nama_pemilik_rekening_info,nama_produk,nama_usaha_mikro,jenis_kontrak,info_lainnya)values('" . $_POST['kode_tender'] . "','" . $_POST['nama_tender'] . "','" . $_POST['lingkup_pekerjaan'] . "','" . $_POST['no_surat'] . "','" . $_POST['tanggal_surat_perjanjian'] . "','" . $_POST['kota_surat_perjanjian'] . "','" . $_POST['tipe_penyedia_ph1'] . "','" . $_POST['nama_penyedia_ph1'] . "','" . $_POST['alamat_penyedia_ph1'] . "','" . $_POST['no_akte_pendirian'] . "','" . $_POST['tanggal_akte_pendirian'] . "','" . $_POST['wakil_sah_penyedia'] . "','" . $_POST['tipe_penyedia_ph2'] . "','" . $_POST['nama_penyedia_ph2'] . "','" . $_POST['alamat_penyedia_ph2'] . "','" . $_POST['nama_bank'] . "','" . $_POST['no_pemilik_rekening'] . "','" . $_POST['nama_pemilik_rekening'] . "','" . $_POST['nilai_kontrak'] . "','" . $_POST['alasan_perubahan_nilai_kontrak'] . "','" . $_POST['nama_pemilik_rekening_info'] . "','" . $_POST['nama_produk_dalam_negri'] . "','" . $_POST['nama_usaha_mikro'] . "','" . $_POST['jenis_kontrak'] . "','" . $_POST['informasi_lainnya'] . "')");
    header('location:add-sppbj-non-tender-'.$_POST['id_non_tender']);
}
